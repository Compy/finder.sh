...
import (
	...
	"github.com/compy/finder.sh/pkg/htmx"
...
type Page struct {
	...
	// Groups stores a list of groups the user is a member of
	Groups []string
...
func NewPage(ctx echo.Context) Page {
	...
	if u := ctx.Get(context.AuthenticatedUserKey); u != nil {
		...
		if groups, err := p.AuthUser.QueryGroups().All(ctx.Request().Context()); err == nil {
